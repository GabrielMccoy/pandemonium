...
Settings are options that would normally be selected within the app. Settings are passed as a named list in the form: `settings=list(k= , linkage= , metric= )`
...
clstr will be a number `1:settings$k` giving the clustering assignment of each point.
