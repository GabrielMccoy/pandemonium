...
# Overview
This vignette describes the Analysis page of the pandemonium app and each of the tabs that are on the page. This is to serve as a reference for understanding these pages and the controls and outputs each of them contains.
...
This tab will show benchmark information for clusters and user assigned groupings if supplied. The first columns of the table will be the linked space values of the benchmark points, then the cluster radius and diameter will be given, finally the score value of the benchmark point will be given if getScores returns a score.
...
Below this plot is 3 settings:
 ...
 - Scale: scales the coordinates by their variation
