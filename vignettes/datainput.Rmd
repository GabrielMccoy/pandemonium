...
On this page Variables can be removed from either space or even moved between them.A Coordinate function can be selected from the input functions. There is also two aditional inputs of groupings or flags and a label.
