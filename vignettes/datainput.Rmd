...
This will automatically sort the variables into numeric and other variables, as well as impute any missing data using `VIM::kNN()` is VIM is installed otherwise entries with misssing data will be removed.
