...
```
By loading the app with the clustering space in `df` and the linked space in `linked` the data is automatically selected in the data page. From here pressing load app will launch the analysis tab.
